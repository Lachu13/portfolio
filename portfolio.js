...
document.querySelector('#contact form').addEventListener('submit', function(e) {
    ...
    // Replace with your WhatsApp number (with country code, no + or 0 in front)
    let phoneNumber = "917603954120"; 

    let whatsappURL = `https://wa.me/${phoneNumber}?text=*New Contact Form Message*%0A
    👤 Name: ${name}%0A
    📧 Email: ${email}%0A
    📝 Subject: ${subject}%0A
    💬 Message: ${message}`;
